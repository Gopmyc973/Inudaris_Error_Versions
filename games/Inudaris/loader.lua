...
Loader:presentLoadingScreen(3/10, "Loading extensions...") ; Functions:extensions()
Loader:presentLoadingScreen(4/10, "Loading objects...")  ; Functions:load_object()
Loader:presentLoadingScreen(5/10, "Loading world...")  ; Functions:load_world()
Loader:presentLoadingScreen(6/10, "Loading player...")  ; Functions:load_player()
Loader:presentLoadingScreen(7/10, "Loading weapons...")  ; Functions:load_weapons()
Loader:presentLoadingScreen(8/10, "Loading enemies...")  ; Functions:load_enemy()
